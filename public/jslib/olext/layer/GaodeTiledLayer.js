define('olext/layer/GaodeTiledLayer',
[
    'OpenLayers'
],
function(OpenLayers) {
    var GaodeTiledLayer = OpenLayers.Class(OpenLayers.Layer.TMS,{
    	type : "GaodeTiledLayer",
    	token : null,
    	numZoomLevels : null,
    	...
    	clone : function(obj) {
    		if (obj == null) {
    			obj = new GaodeTiledLayer(this.name, this.url, this.getOptions());
    		}
    		//ArcGISCache
    		obj = OpenLayers.Layer.TMS.prototype.clone.apply(this, [obj]);
    		return obj;
    	},
    	CLASS_NAME: "olext.layer.GaodeTiledLayer"

    });
    
    return GaodeTiledLayer;
})